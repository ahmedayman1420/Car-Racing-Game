...
class FullscreenTriangleState : public our::State
{
    ...
    void onInitialize() override
    {
        ...
        //==//Create One Vertex Array Object (id).
        glGenVertexArrays(1, &id);

        //==//Bind (Selects) Created Object (id), It Just Selects Object To Put It In Context.
    ...
    void onDraw(double deltaTime) override
    {
        ...
        //==//Draw a Triangle From Index Zero & Count Three Sequential Elements From The Enabled Array
